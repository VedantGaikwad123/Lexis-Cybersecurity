...
def build_part2(styles, nmap_outputs, nmap_screenshots):
    ...
    elements.append(code_block(nmap_outputs.get("sn", "Output not available")))
    # Screenshot
    ...
    elements.append(Spacer(1, 0.2*cm))
    elements.append(code_block(nmap_outputs.get("sV", "Output not available")))
    ...
    elements.append(Spacer(1, 0.2*cm))
    elements.append(code_block(nmap_outputs.get("A", "Output not available")))
